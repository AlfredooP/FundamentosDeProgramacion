 ...
 * @author aa510
 */
public class FD_2022_10_17_PromocionEsferaCaracter {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("VERSION CON COLOR DE ESFERA CON CARACTER, EN LUGAR DE CADENA");
        System.out.print("");
        ...
        ColorEsfera = teclado.next().charAt(0);//Regresa el primer caracter de la cadena leída
